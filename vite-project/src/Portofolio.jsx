...
const cardCenterAbsolute = switchThreshold + (0.5 - p1AtSwitch * 0.25) * vh;
  ...
  const SOCIAL_LINKS = [
  { name: "Instagram",  url: "https://www.instagram.com/naufalnawwaf_/" },
  { name: "LinkedIn", url: "https://www.linkedin.com/in/muhammad-nawwaf-naufal-36a559281/" },
  { name: "GitHub",   url: `https://github.com/${GITHUB_USERNAME}` },
];
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    Backend Engineer &amp;<br/>scalable digital systems.
                  </p>
